...
\begin{table}[H]
  ...
  \begin{tabular}{@{}llll@{}}
    ...
    Flywheel material density & $\rho$ & \num{7750} & \si{\kilo\gram\per\meter\cubed} \\
...
\textbf{Requirements Met:} Flywheel design (4.48 kg·m² moment of inertia, achieving target coefficient of fluctuation of 0.003), power output analysis using two methods (ideal Stirling cycle: 94.9 J/cycle, Schmidt analysis: 23.0 J/cycle), systematic phase optimization identifying optimal angle of 103.6°, and effective speed regulation maintaining 650 RPM ± 1.0 RPM.
...
\section{References}
\begin{enumerate}
\item Anderson, M., \& Severson, E. (2025). ME 4053: Fall 2025 Project 1 - Stirling Engine Analysis \& Flywheel Design. Mechanical Engineering Department, University of Minnesota, September 9th, 2025.
\item Anderson, M., \& Severson, E. (2025). Appendix B: Problem specifications. Mechanical Engineering Department, University of Minnesota.
\item Anthropic. (2024). Claude AI Assistant. Retrieved from https://claude.ai
\item OpenAI. (2024). ChatGPT AI Assistant. Retrieved from https://chat.openai.com
\end{enumerate}

\vspace{1em}
\noindent\textbf{AI Disclaimer:} This report was prepared with the assistance of artificial intelligence tools for code development, data processing, and document formatting. All technical calculations, engineering analysis, and conclusions presented have been validated by the authors. The AI assistance was used solely to enhance the efficiency of the analysis process and does not compromise the accuracy or academic integrity of this work.
